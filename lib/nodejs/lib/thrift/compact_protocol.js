...
var TProtocolException = require('./protocol_exception');
var TProtocolExceptionType = TProtocolException.types;
...
TCompactProtocol.prototype.writeVarint64 = function(n) {
  ...
  if (! (n instanceof Int64)) {
    throw new TProtocolException(TProtocolExceptionType.INVALID_DATA, "Expected Int64 or Number, found: " + n);
  }
...
TCompactProtocol.prototype.i64ToZigzag = function(l) {
  ...
  if (! (l instanceof Int64)) {
    throw new TProtocolException(TProtocolExceptionType.INVALID_DATA, "Expected Int64 or Number, found: " + l);
  }
...
TCompactProtocol.prototype.readBinary = function() {
  ...
  // Catch error cases
  if (size < 0) {
    throw new TProtocolException(TProtocolExceptionType.NEGATIVE_SIZE, "Negative binary/string size");
  }
