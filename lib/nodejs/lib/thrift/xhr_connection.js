 ...
 */
var XHRConnection = exports.XHRConnection = function(host, port, options) {
 ...
 */
XHRConnection.prototype.jqRequest = function(client, postData, args, recv_method) {
 ...
 * @param {XHRConnection} xhrConnection - The connection to use.
 * @returns {object} The client object.
 * @see {@link createXHRConnection}
 */
exports.createXHRClient = function(cls, xhrConnection) {
  if (cls.Client) {
    cls = cls.Client;
  }
  xhrConnection.client =
    new cls(new xhrConnection.transport(undefined, function(buf) {
        xhrConnection.write(buf);
      }),
      xhrConnection.protocol);
  return xhrConnection.client;
};
