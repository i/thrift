...
var net = require('net');
var tls = require('tls');
var TApplicationException = require('./application_exception');
var TApplicationExceptionType = TApplicationException.types;
    ...
    try {
      while (true) {
        ...
        if(client['recv_' + header.fname]) {
          ...
          self.emit("error",
                    new TApplicationException(TApplicationExceptionType.WRONG_METHOD_NAME,
